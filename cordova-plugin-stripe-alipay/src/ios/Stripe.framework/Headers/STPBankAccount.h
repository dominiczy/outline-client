 ...
 */
- (instancetype)init
    __attribute__((unavailable("You cannot directly instantiate an STPBankAccount. You should only "
                               "use one that has been returned from an STPAPIClient callback.")));
...
@property(nonatomic, readonly)
    NSString *bankAccountId DEPRECATED_MSG_ATTRIBUTE("Use stripeID (defined in STPSourceProtocol)");
