 ...
 */
typedef void (^STPRedirectContextSourceCompletionBlock)(NSString *sourceID,
                                                        NSString *__nullable clientSecret,
...
__attribute__((deprecated(
    ...
    "STPRedirectContextSourceCompletionBlock"))) typedef STPRedirectContextSourceCompletionBlock
...
/**
 ...
 internet connection, or servers are down).
 */
typedef void (^STPRedirectContextPaymentIntentCompletionBlock)(NSString *clientSecret,
                                                               NSError *__nullable error);
...
- (nullable instancetype)initWithPaymentIntent:(STPPaymentIntent *)paymentIntent
                                    completion:
                                        (STPRedirectContextPaymentIntentCompletionBlock)completion;
