...
- (instancetype)init __attribute__((
    unavailable("You cannot directly instantiate an STPPaymentIntentSourceAction.")));
...
/**
 The details for authorizing via URL, when `type ==
 STPPaymentIntentSourceActionTypeAuthorizeWithURL`
 */
@property(nonatomic, nullable, readonly)
    STPPaymentIntentSourceActionAuthorizeWithURL* authorizeWithURL;
