...
/**
 Set your Stripe API key with this method. New instances of STPAPIClient will be initialized with
 this value. You should call this method as early as possible in your application's lifecycle,
 preferably in your AppDelegate.

 @param   publishableKey Your publishable key, obtained from https://stripe.com/account/apikeys
 @warning Make sure not to ship your test API keys to the App Store! This will log a warning if you
 use your test key in a release build.
 */
...
/**
 A shared singleton API client. Its API key will be initially equal to [Stripe
...
/**
 ...
 @param bankAccount The user's bank account details. Cannot be nil. @see
 https://stripe.com/docs/api#create_bank_account_token
 @param completion  The callback to run with the returned Stripe token (and any errors that may have
 occurred).
 */
- (void)createTokenWithBankAccount:(STPBankAccountParams *)bankAccount
                        completion:(__nullable STPTokenCompletionBlock)completion;
...
/**
 ...
 @param pii The user's personal identification number. Cannot be nil. @see
 https://stripe.com/docs/api#create_pii_token
 @param completion  The callback to run with the returned Stripe token (and any errors that may have
 occurred).
 */
- (void)createTokenWithPersonalIDNumber:(NSString *)pii
                             completion:(__nullable STPTokenCompletionBlock)completion;
...
/**
 ...
 This allows the connected account to accept the Terms of Service, and/or send Legal Entity
 information.
 ...
 occurred).
 */
- (void)createTokenWithConnectAccount:(STPConnectAccountParams *)account
                           completion:(__nullable STPTokenCompletionBlock)completion;
...
/**
 ...
 @param card        The user's card details. Cannot be nil. @see
...
/**
 ...
 @param completion  The callback to run with the returned Source object, or an error.
 */
- (void)retrieveSourceWithId:(NSString *)identifier
...
/**
 ...
 @param identifier  The identifier of the source to be retrieved. Cannot be nil.
 @param secret      The client secret of the source. Cannot be nil.
 @param timeout     The timeout for the polling operation, in seconds. Timeouts are capped at 5
 minutes.
 @param completion  The callback to run with the returned Source object, or an error.
 */
- (void)startPollingSourceWithId:(NSString *)identifier
                    clientSecret:(NSString *)secret
                         timeout:(NSTimeInterval)timeout
                      completion:(STPSourceCompletionBlock)completion
    NS_EXTENSION_UNAVAILABLE("Source polling is not available in extensions")
        DEPRECATED_MSG_ATTRIBUTE(
            "You should poll your own backend to update based on source status change webhook "
...
- (void)stopPollingSourceWithId:(NSString *)identifier
    NS_EXTENSION_UNAVAILABLE("Source polling is not available in extensions")DEPRECATED_ATTRIBUTE;
...
/**
 Retrieves the PaymentIntent object using the given secret. @see
 https://stripe.com/docs/api#retrieve_payment_intent
...
/**
 ...
 @param completion           The callback to run with the returned PaymentIntent object, or an
 error.
 */
...
/**
 ...
 `application:continueUserActivity:restorationHandler:` To learn more about universal links, see
 https://developer.apple.com/library/content/documentation/General/Conceptual/AppSearch/UniversalLinks.html

 If you are using a native scheme URL, you will receive the callback in
 `application:openURL:options:` To learn more about native url schemes, see
