 ...
 */
- (instancetype)init
    __attribute__((unavailable("You cannot directly instantiate an STPCard. You should only use "
...
@property(nonatomic, readonly)
    NSString *cardId DEPRECATED_MSG_ATTRIBUTE("Use stripeID (defined in STPSourceProtocol)");

/**
 The first line of the cardholder's address
 */
@property(nonatomic, nullable, readonly)
    NSString *addressLine1 DEPRECATED_MSG_ATTRIBUTE("Use address.line1");

/**
 The second line of the cardholder's address
 */
@property(nonatomic, nullable, readonly)
    NSString *addressLine2 DEPRECATED_MSG_ATTRIBUTE("Use address.line2");

/**
 The city of the cardholder's address
 */
@property(nonatomic, nullable, readonly)
    NSString *addressCity DEPRECATED_MSG_ATTRIBUTE("Use address.city");

/**
 The state of the cardholder's address
 */
@property(nonatomic, nullable, readonly)
    NSString *addressState DEPRECATED_MSG_ATTRIBUTE("Use address.state");

/**
 The zip code of the cardholder's address
 */
@property(nonatomic, nullable, readonly)
    NSString *addressZip DEPRECATED_MSG_ATTRIBUTE("Use address.postalCode");

/**
 The country of the cardholder's address
 */
@property(nonatomic, nullable, readonly)
    NSString *addressCountry DEPRECATED_MSG_ATTRIBUTE("Use address.country");
...
- (instancetype)initWithID:(NSString *)cardID
                  ...
                  expMonth:(NSUInteger)expMonth
                   ...
                   funding:(STPCardFundingType)funding DEPRECATED_MSG_ATTRIBUTE(
                               "You cannot directly instantiate an STPCard. You should only use "
                               "one that has been returned from an STPAPIClient callback.");
