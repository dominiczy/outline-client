...
// ObjC <-> Swift error bridging code from
// https://gist.github.com/bdash/bf29e26c429b78cc155f1a2e1d851f8b
#if __has_attribute(ns_error_domain)
#define STP_ERROR_ENUM(type, name, domain)                                                      \
  _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Wignored-attributes\"") \
      NS_ENUM(type, __attribute__((ns_error_domain(domain))) name) _Pragma("clang diagnostic pop")
#else
