...
/**
 Representation of a customer's payment instrument created with the Stripe API. @see
 ...
 */
- (instancetype)init
    __attribute__((unavailable("You cannot directly instantiate an STPSource. You should only use "
