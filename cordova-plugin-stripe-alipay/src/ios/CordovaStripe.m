...
- (void)pluginInitialize {
  CardBrands =
      [[NSArray alloc] initWithObjects:@"Visa", @"American Express", @"MasterCard", @"Discover",
                                       @"JCB", @"Diners Club", @"Unknown", nil];
}
...
- (void)initializeApplePayTransaction:(CDVInvokedUrlCommand *)command {
  ...
  PKPaymentRequest *paymentRequest = [Stripe paymentRequestWithMerchantIdentifier:merchantIdentifier
                                                                          country:country
                                                                         currency:currency];
  ...
  for (NSDictionary *item in items) {
    [paymentSummaryItems
        addObject:[PKPaymentSummaryItem
                      summaryItemWithLabel:item[@"label"]
                                    amount:[NSDecimalNumber
                                               decimalNumberWithString:item[@"amount"]]]];
  }
  ...
  if ([Stripe canSubmitPaymentRequest:paymentRequest]) {
    ...
    [self.viewController presentViewController:paymentAuthorizationViewController
                                      animated:YES
                                    completion:nil];
...
- (void)processPayment:(PKPaymentAuthorizationViewController *)controller
      ...
      createTokenWithPayment:payment
                  completion:^(STPToken *token, NSError *error) {
                    ...
                    if (error != nil) {
                      ...
                      result = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR
                                                 messageAsString:@"Unable to retrieve token"];
                    } else {
                    ...
                    [self.commandDelegate sendPluginResult:result
                                                callbackId:self.applePayCDVCallbackId];
...
- (void)finalizeApplePayTransaction:(CDVInvokedUrlCommand *)command {
  ...
  if (self.applePayCompleteCallback) {
    self.applePayCompleteCallback(successful ? PKPaymentAuthorizationStatusSuccess
...
- (void)checkApplePaySupport:(CDVInvokedUrlCommand *)command {
  CDVPluginResult *const result =
      [CDVPluginResult resultWithStatus:CDVCommandStatus_OK
                          messageAsBool:[Stripe deviceSupportsApplePay]];
  [self.commandDelegate sendPluginResult:result callbackId:command.callbackId];
}
...
- (void)throwNotInitializedError:(CDVInvokedUrlCommand *)command {
  CDVPluginResult *result = [CDVPluginResult
      resultWithStatus:CDVCommandStatus_ERROR
       messageAsString:@"You must call setPublishableKey method before executing this command."];
  [self.commandDelegate sendPluginResult:result callbackId:command.callbackId];
}

- (void (^)(STPToken *_Nullable token,
            NSError *_Nullable error))handleTokenCallback:(CDVInvokedUrlCommand *)command {
...
- (void)validateCardNumber:(CDVInvokedUrlCommand *)command {
  STPCardValidationState state =
      [STPCardValidator validationStateForNumber:[command.arguments objectAtIndex:0]
                             validatingCardBrand:YES];
  CDVPluginResult *result = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK
                                                messageAsBool:state == STPCardValidationStateValid];
  [self.commandDelegate sendPluginResult:result callbackId:command.callbackId];
}
...
- (void)validateCVC:(CDVInvokedUrlCommand *)command {
  STPCardValidationState state =
      [STPCardValidator validationStateForCVC:[command.arguments objectAtIndex:0]
                                    cardBrand:STPCardBrandUnknown];
  CDVPluginResult *result = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK
                                                messageAsBool:state == STPCardValidationStateValid];
  [self.commandDelegate sendPluginResult:result callbackId:command.callbackId];
}
...
- (void)getCardType:(CDVInvokedUrlCommand *)command {
  ...
  CDVPluginResult *result =
      [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString:CardBrands[brand]];
  [self.commandDelegate sendPluginResult:result callbackId:command.callbackId];
}
  ...
  [self.commandDelegate runInBackground:^{
    ...
    switch (type) {
      case 0:
        // 3DS
        sourceParams =
            [STPSourceParams threeDSecureParamsWithAmount:[params[@"amount"] integerValue]
      ...
      case 1:
        // GiroPay
        sourceParams = [STPSourceParams giropayParamsWithAmount:[params[@"amount"] integerValue]
                                                           name:params[@"name"]
                                                      returnURL:params[@"returnURL"]
      ...
      case 2:
        // iDEAL
        sourceParams = [STPSourceParams idealParamsWithAmount:[params[@"amount"] integerValue]
                                                         name:params[@"name"]
                                                    returnURL:params[@"returnURL"]
                                          statementDescriptor:params[@"statementDescriptor"]
                                                         bank:params[@"bank"]];
      ...
      case 3:
        // SEPA Debit
        sourceParams = [STPSourceParams sepaDebitParamsWithName:params[@"name"]
                                                           iban:params[@"iban"]
      ...
      case 4:
        // Sofort
        sourceParams = [STPSourceParams sofortParamsWithAmount:[params[@"amount"] integerValue]
                                                     returnURL:params[@"returnURL"]
                                                       country:params[@"country"]
                                           statementDescriptor:params[@"statementDescriptor"]];
        break;
      ...
      case 5:
        // Alipay
        sourceParams = [STPSourceParams alipayParamsWithAmount:[params[@"amount"] integerValue]
                                                      currency:params[@"currency"]
                                                     returnURL:params[@"returnURL"]];
        break;
      ...
      case 6:
        // Alipay Reusable
        sourceParams = [STPSourceParams alipayReusableParamsWithCurrency:params[@"currency"]
                                                               returnURL:params[@"returnURL"]];
        break;

      case 7:
        // P24
        sourceParams = [STPSourceParams p24ParamsWithAmount:[params[@"amount"] integerValue]
                                                   currency:params[@"currency"]
                                                      email:params[@"email"]
                                                       name:params[@"name"]
                                                  returnURL:params[@"returnURL"]];
      ...
      default:
        [self.commandDelegate
            sendPluginResult:[CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR
                                               messageAsString:@"Invalid source type"]
                  callbackId:command.callbackId];
        return;
    }

    [self.client createSourceWithParams:sourceParams
                             completion:^(STPSource *_Nullable source, NSError *_Nullable error) {
                               CDVPluginResult *pluginResult;
                               if (source != nil) {
                                 pluginResult =
                                     [CDVPluginResult resultWithStatus:CDVCommandStatus_OK
                                                   messageAsDictionary:source.allResponseFields];
                               } else {
                                 pluginResult =
...
- (void)createPiiToken:(CDVInvokedUrlCommand *)command {
  [self.commandDelegate runInBackground:^{
    ...
    [self.client
        createTokenWithPersonalIDNumber:pid
                             completion:^(STPToken *_Nullable token, NSError *_Nullable error) {
                               ...
                               if (error != nil) {
                                 ...
                                 pluginResult =
                                     [CDVPluginResult resultWithStatus:CDVCommandStatus_OK
                                                   messageAsDictionary:token.tokenId];
                               }
...
- (void)createAccountToken:(CDVInvokedUrlCommand *)command {
  ...
  [self.client
      createTokenWithConnectAccount:params
                         completion:^(STPToken *_Nullable token, NSError *_Nullable error) {
                           CDVPluginResult *pluginResult;
                           if (error != nil) {
                             pluginResult =
