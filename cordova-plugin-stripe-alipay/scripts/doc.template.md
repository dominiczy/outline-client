...
[![npm](https://img.shields.io/npm/l/cordova-plugin-stripe-alipay.svg)](https://www.npmjs.com/package/cordova-plugin-stripe-alipay/)
[![npm](https://img.shields.io/npm/dt/cordova-plugin-stripe-alipay.svg)](https://www.npmjs.com/package/cordova-plugin-stripe-alipay)
[![npm](https://img.shields.io/npm/dm/cordova-plugin-stripe-alipay.svg)](https://www.npmjs.com/package/cordova-plugin-stripe-alipay)
...
```shell
cordova plugin add https://github.com/zyramedia/cordova-plugin-stripe-alipay#:/tests
```
...
*Thanks to [klirix](https://github.com/klirix) for submitting a [PR](https://github.com/zyramedia/cordova-plugin-stripe-alipay/pull/5) for the browser platform.*


<br><br>
## Contribution
- **Having an issue**? or looking for support? [Open an issue](https://github.com/zyra/cordova-plugin-stripe-alipay/issues/new) and we will get you the help you need.
